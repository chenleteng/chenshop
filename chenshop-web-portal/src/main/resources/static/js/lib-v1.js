...
var category = {
    OBJ: $("#_JD_ALLSORT"),
    URL_Serv: "http://localhost:9000/api/v1/item/cat/list",
    ...
    FN_GetLink: function (a, b) {
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.leeshop.com" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
    },
