var NthTabs = function () {
    ...
    var handleHome = function (src) {
        nthTabs.addTab({
            id: "home",
            title: "首页",
            content: '<iframe name="iframe0" width="100%" height="775" src="' + src + '" frameborder="0"></iframe>',
            allowClose: false,
            active: true
        });
    };
    ...
    var handleAddTab = function (id, title, src) {
        ...
        nthTabs.addTab({
            id: id,
            title: title,
            content: '<iframe name="iframe' + id + '" width="100%" height="775" src="' + src + '" frameborder="0"></iframe>'
        });
        nthTabs.setActTab(id);
    };
